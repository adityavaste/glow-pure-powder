    ...
    <header className="sticky top-0 z-40 backdrop-blur-md bg-background/70 border-b border-border/60">
      <div className="mx-auto max-w-7xl px-6 h-16 flex items-center justify-between">
        ...
        <nav className="hidden md:flex items-center gap-8 text-sm">
          ...
          <Link to="/story" activeProps={{ className: "text-foreground" }} className="text-muted-foreground hover:text-foreground transition">Story</Link>
        </nav>
    ...
    <footer className="border-t border-border/60 mt-24">
      <div className="mx-auto max-w-7xl px-6 py-12 grid md:grid-cols-3 gap-8 text-sm">
        ...
        <div className="space-y-2">
          ...
          <Link to="/story" className="block text-muted-foreground hover:text-foreground">Our Story</Link>
        </div>
        <div className="space-y-2">
